$(function(){
	...
	$("#system-table").listview({
		...
		eachItem:function(ui, item){
			...
			html+="<td>"+ item.panel_brand +"</td>";
			html+="<td>"+ item.panel_model +"</td>";
			html+="<td>"+ item.panel_size +"</td>";
			...
			html+="<li><a target='iframe' href='product_edit.html?id="+ item.id +"' target='iframe' class='operate-icon17' title='修改产品属性'></a></li>";
			html+="<li><a target='iframe' href='product_add_file.html?t=list&m="+ item.panel_model +"' target='iframe' class='operate-icon5' title='编辑产品文档'></a></li>";
			html+="</ul>";
			html+="</div> </td>";
			html+="</tr>";
			var tr = $(html);
