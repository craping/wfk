			...
			if(data.info.length>0){
				$.each(data.info,function(i,j){
					...
					html +='<table>';
						html +='<thead>';
							html +='<tr>';
								...
								html +='<th width="5%"><a href="freight.html?tid='+j.tid+'&supId='+supId+'">修改</a></th>';
								html +='<th><a href="javascript:;" class="deleteTmep" name="'+j.tid+'"> 删除 </a><span class="freight-template-span1"></span></th>';
							html +='</tr>';
						html +='</thead>';
					html +='<tbody style="display: none;">'; 
						...
						html +='</tr>';
						html +='<tr><td colspan="4" style="text-align: right;"><span class="">共有'+j.proNumber+'款商品在使用此模版 </span></td></tr>';
						})
					html +='</tbody>';
					html +='</table>';
					html +='</div>';
