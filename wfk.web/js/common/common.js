...
//    pageFixedHidden(".media");
//    pageFixedHidden(".subscription");
//    pageFixedHidden(".sales");
//    pageFixedHidden(".xinhua-com");
//});
...
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^    7.5 增加
 $(window).load(function(){
	//浏览器中头部BOE官网唤醒方法
	 setTimeout(function(){
			var userAgent = navigator.userAgent.toLowerCase();//获取app信息
			if(navigator.userAgent.match(/(iPhone|iPod|iPad|android);?/i)&&(windW<760)){
				if(navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)&&(userAgent.indexOf("boeiosapp_useragent") == -1)){//ios浏览器里面
					if(userAgent.indexOf("fxios") != -1||userAgent.indexOf("crios") != -1||userAgent.indexOf("ucbrowser") != -1||userAgent.indexOf("mqqbrowser") != -1||userAgent.indexOf("qbwebviewtype") != -1||userAgent.indexOf("safari") != -1) {
						$("#downBOEgw").css("display","block");
						$("#clear-nav").css("height","106px");
						$(".closeDownBOEgw").click(function(){
							$("#downBOEgw").css("display","none");
							$("#clear-nav").css("height","60px");
						});
					} else {
						$("#downBOEgw").css("display","none");
					}
					//官网唤醒
				 	$("#boegw").click(function(){
				 		chooseBOEgw("https://itunes.apple.com/cn/app/boe-guan-wang/id1191742066?mt=8","rouseIostest://","http://www.boe.com/boeapp/download.html","boe://");
				 	});
				 	//画屏唤醒
				 	$("#huaping").click(function(){
				 		choose("itms-apps://itunes.apple.com/us/app/id1150322560?l=zh&ls=1&mt=81","jingdongfang://","http://ig.boe.com/assets/upload/bannerimages/iGalleryboe.apk","igallery://openapp");
				 	});
				 	//移动健康唤醒
				 	$("#boehealth").click(function(){
				 		choose("https://itunes.apple.com/app/id1303309348","mhealth2017://","http://ssc.boe.com/v1/mhealth-api/mhealth/version/latest/download?appType=android","mhealth://com.boe.mhealth");
				 	});
				}else if(navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)&&(userAgent.indexOf("boeiosapp_useragent") != -1)){//iosAPP里面
					$("#downBOEgw").css("display","none");
					$("#huaping").click(function(){
						window.webkit.messageHandlers.openOtherApp.postMessage({body: [{"urlScheme":"jingdongfang://", "itemsApp":"itms-apps://itunes.apple.com/us/app/id1150322560?l=zh&ls=1&mt=81","openType":"画屏"}]});
					});
					$("#boehealth").click(function(){
						window.webkit.messageHandlers.openOtherApp.postMessage({body: [{"urlScheme":"mhealth2017://", "itemsApp":"https://itunes.apple.com/app/id1303309348","openType":"移动健康"}]});
					});
					
				}else if(navigator.userAgent.match(/android/i)&&(userAgent.indexOf("boeandroid") == -1)){
					$("#downBOEgw").css("display","block");
					$("#clear-nav").css("height","106px");
					$(".closeDownBOEgw").click(function(){
						$("#downBOEgw").css("display","none");
		...
		//头部BOE官网唤醒
	 	$("#boegwtop").click(function(){
			chooseBOEgw("https://itunes.apple.com/cn/app/boe-guan-wang/id1191742066?mt=8","rouseIostest://","http://www.boe.com/boeapp/download.html","boe://");
		});
	 	function chooseBOEgw(urlIos,schemeIos,urlAndroid,schemeAndroid){
	 		var str = location.href;
	 		var new_str=str.indexOf("https",0);
	 		if(new_str=-1){
	 			new_str = str.substring(7);
	 			}else{
	 			new_str = str.substring(8);
	 		};
	 		if(navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)){
	 			...
	 			window.location=schemeIos+new_str;
	 		}else if(navigator.userAgent.match(/android/i)){
	 			var clickedAt = +new Date();
	 			var ifr=document.createElement("iframe");
	 			ifr.src=schemeAndroid+new_str;
